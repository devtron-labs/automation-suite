...
func (suite *AppStoreTestSuite) TestGetApplicationValuesListWithValidAppStoreId() {
...
func (suite *AppStoreTestSuite) TestGetApplicationValuesListWithInValidAppStoreId() {
