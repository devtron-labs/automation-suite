...
//func CheckWithCiCd(authToken string, useCustomInputValues bool, createAppApiResponse CreateAppRequestDto ) (testUtils.CreateAppRequestDto, dtos.CreateWorkflowResponseDto) {
//	if createAppApiResponsePtr != nil && workflowResponsePtr != nil {
//		return *createAppApiResponsePtr, *workflowResponsePtr
//	}
//	config, _ := GetEnvironmentConfigPipelineConfigRouter()
